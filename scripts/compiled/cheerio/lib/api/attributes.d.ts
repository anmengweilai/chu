 ...
 */
export declare function attr<T extends Node>(
  this: Cheerio<T>,
  name: string,
): string | undefined;
/**
 ...
 */
export declare function prop<T extends Node>(
  this: Cheerio<T>,
...
export declare function prop<T extends Node, K extends keyof Element>(
  this: Cheerio<T>,
  name: K,
): Element[K];
export declare function prop<T extends Node, K extends keyof Element>(
 ...
 */
export declare function data<T extends Node>(
  this: Cheerio<T>,
  name: string,
): unknown | undefined;
/**
 ...
 */
export declare function val<T extends Node>(
  this: Cheerio<T>,
 ...
 */
export declare function removeAttr<T extends Node>(
  this: Cheerio<T>,
  name: string,
): Cheerio<T>;
/**
 ...
 */
export declare function hasClass<T extends Node>(
  this: Cheerio<T>,
  className: string,
): boolean;
/**
 ...
 */
export declare function addClass<T extends Node, R extends ArrayLike<T>>(
  this: R,
  value?:
    | string
 ...
 */
export declare function removeClass<T extends Node, R extends ArrayLike<T>>(
  this: R,
  name?:
    | string
    | ((this: Element, i: number, className: string) => string | undefined),
 ...
 */
export declare function toggleClass<T extends Node, R extends ArrayLike<T>>(
  this: R,
  value?:
    | string
    | ((
