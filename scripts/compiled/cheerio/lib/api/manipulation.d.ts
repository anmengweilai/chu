...
import type { AcceptedElems, BasicAcceptedElems } from '../types';
 ...
 */
export declare function _makeDomArray<T extends Node>(
  this: Cheerio<T>,
 ...
 */
export declare function appendTo<T extends Node>(
  this: Cheerio<T>,
 ...
 */
export declare function prependTo<T extends Node>(
  this: Cheerio<T>,
  target: BasicAcceptedElems<Node>,
): Cheerio<T>;
/**
 ...
 */
export declare const append: <T extends Node>(
  this: Cheerio<T>,
  ...elems:
 ...
 */
export declare const prepend: <T extends Node>(
  this: Cheerio<T>,
  ...elems:
    | [(this: Node, i: number, html: string) => BasicAcceptedElems<Node>]
    | BasicAcceptedElems<Node>[]
 ...
 */
export declare const wrap: <T extends Node>(
  this: Cheerio<T>,
 ...
 */
export declare const wrapInner: <T extends Node>(
  this: Cheerio<T>,
  wrapper: AcceptedElems<Node>,
) => Cheerio<T>;
/**
 ...
 */
export declare function unwrap<T extends Node>(
  this: Cheerio<T>,
  selector?: string,
): Cheerio<T>;
/**
 ...
 */
export declare function wrapAll<T extends Node>(
  this: Cheerio<T>,
 ...
 */
export declare function insertAfter<T extends Node>(
  this: Cheerio<T>,
  target: BasicAcceptedElems<Node>,
): Cheerio<T>;
/**
 ...
 */
export declare function before<T extends Node>(
  this: Cheerio<T>,
  ...elems:
    | [(this: Node, i: number, html: string) => BasicAcceptedElems<Node>]
    | BasicAcceptedElems<Node>[]
 ...
 */
export declare function insertBefore<T extends Node>(
  this: Cheerio<T>,
  target: BasicAcceptedElems<Node>,
): Cheerio<T>;
/**
 ...
 */
export declare function remove<T extends Node>(
  this: Cheerio<T>,
  selector?: string,
): Cheerio<T>;
/**
 ...
 */
export declare function replaceWith<T extends Node>(
  this: Cheerio<T>,
...
export declare function html<T extends Node>(
  this: Cheerio<T>,
...
export declare function text<T extends Node>(
  this: Cheerio<T>,
