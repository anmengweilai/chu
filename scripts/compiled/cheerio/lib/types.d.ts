...
export declare type BasicAcceptedElems<T extends Node> =
  | Cheerio<T>
  | T[]
  | T
  | string;
/** Elements that can be passed to manipulation methods, including functions. */
export declare type AcceptedElems<T extends Node> =
...
export declare type AcceptedFilters<T> =
  | string
  | FilterFunction<T>
  | T
  | Cheerio<T>;
