declare module '../index' {
  ...
  interface LoDashStatic {
    ...
    groupBy<T extends object>(
      collection: T | null | undefined,
      iteratee?: ValueIteratee<T[keyof T]>,
    ): Dictionary<[T[keyof T], ...Array<T[keyof T]>]>;
  }
  interface String {
    /**
     * @see _.groupBy
  ...
  interface Object<T> {
    ...
    groupBy(
      iteratee?: ValueIteratee<T[keyof T]>,
    ): Object<Dictionary<[T[keyof T], ...Array<T[keyof T]>]>>;
  }
  interface StringChain {
    /**
     * @see _.groupBy
    ...
    groupBy(
      iteratee?: ValueIteratee<string>,
    ): ObjectChain<Dictionary<[string, ...string[]]>>;
  }
  interface StringNullableChain {
    /**
     * @see _.groupBy
  ...
  interface ObjectChain<T> {
    ...
    groupBy(
      iteratee?: ValueIteratee<T[keyof T]>,
    ): ObjectChain<Dictionary<[T[keyof T], ...Array<T[keyof T]>]>>;
  }
  interface LoDashStatic {
    /**
