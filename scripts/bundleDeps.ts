...
Object.keys(exported).forEach(function (key) {
  ...
  Object.defineProperty(exports, key, {
    ...
    get: function get() {
      ...
      if (
        [
          'chalk', // TODO packages/utils/compiled/chalk/source/vendor/supports-color/index.d.ts 文件中 import {WriteStream} from '../../../node:tty';   ---> import {WriteStream} from 'node:tty';
          'pkg-up',
          'execa',
          'globby',
          'os-locale',
